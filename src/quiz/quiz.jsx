...
export default function Quizz() {
  ...
  return (
    ...
    {showPontuacao ? (<div className='pontuacao'>
            <h1>Parabéns</h1>
            <span id="resultado-Final">sua pontuação é  <strong>{pontos}</strong>  de  <strong>{questions.length}</strong></span></div>):(
        <>
        <div className='infoperguntas'>
            <div className='contagemPerguntas'>
                <p id="questao">Pergunta {perguntaAtual + 1}/{questions.length}</p>
            </div>
